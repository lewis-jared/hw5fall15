...
Scenario: sort movies alphabetically
  ...
  When I have selected the Movie Title heading
  ...
  And I should see "The Terminator" before "When Harry Meet Sally"


Scenario: sort movies in increasing order of release date
  When I have selected the Release Date heading
  ...
  And I should see "The Terminator" before "When Harry Meet Sally"
  And I should see "When Harry Meet Sally" before "Aladdin"
